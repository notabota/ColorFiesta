 ...
 */
{
  ...
  class Overlay {
    constructor() {
      ...
      this.DOM.link = this.DOM.el.querySelector("#overlay__link");
    }
    show(contentItem) {
  ...
  class Grid {
    constructor(el) {
        ...
        (item) => {
          ...
          if (!item.classList.contains("grid__item--noclick")) {
            itemObj.DOM.el.addEventListener("click", (ev) => {
              ...
              document.querySelector("#overlay__link").href = item.getAttribute(
                "link"
              );
            });
          }
      ...
      this.overlay.DOM.link.addEventListener("click", () =>
        window.open(this.overlay.DOM.link.href)
      );
    }
